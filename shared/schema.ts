...
export const eras: Era[] = [
  ...
  },
  {
    ...
    context: "The 2000s-2020s saw medical devices shrink to wearable form factors. Continuous glucose monitors, insulin pumps, and smart inhalers empowered patients to manage chronic conditions at home, shifting care from reactive hospital visits to proactive daily management.",
    devices: [
      {
        id: "cgm",
      ...
      },
      {
        ...
        ethics: "Pumps can malfunction, causing life-threatening over- or under-delivery. Rigorous systems integration testing and root cause analysis of anomalies are critical. Comprehensive QA testing - from bench validation to cloud connectivity - is essential for medical device reliability. Should devices have fail-safes, even if they reduce user control?",
        interactionType: "comparison",
